//Jimenez Delgado Edson Ivan
package mx.edu.tesoem.isc.eijd.dam_app2;
...
public class MainActivity extends AppCompatActivity {
    ImageView imagen;
    TextView letrero,txtsr,txttemp;
    Button btn;
    int sr,temp;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtsr = (TextView) findViewById(R.id.SRtxt);
        txttemp = (TextView) findViewById(R.id.TEMPtxt);
